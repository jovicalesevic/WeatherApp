const translations = {
    sr: {
        ...
        installText: 'Instaliraj aplikaciju za brži pristup.',
        installAction: 'Instaliraj',
        analyticsTitle: 'Mini analytics',
        analyticsSearches: 'Pretraga (7 dana)',
        analyticsAverageTemp: 'Prosečna temp.',
        offlineSnapshot: 'Prikazani su poslednji dostupni podaci (offline režim).',
    ...
    en: {
        ...
        installText: 'Install the app for faster access.',
        installAction: 'Install',
        analyticsTitle: 'Mini analytics',
        analyticsSearches: 'Searches (7 days)',
        analyticsAverageTemp: 'Average temp',
        offlineSnapshot: 'Showing last available data (offline mode).',
